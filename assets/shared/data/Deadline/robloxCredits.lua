...
-----------------musicians--------------------
	...
	makeLuaText("musicians", 'Orichi', 0, 170, 250); --change this to musicians name
...
-----------------quote lol--------------------
	...
	makeLuaText("quote", 'Your account will be terminated on March 18th.', 0, 20, 385); --quote editing here
	addLuaText('quote');
