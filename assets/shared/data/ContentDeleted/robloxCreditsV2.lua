function onCreate()
    ...
    makeLuaText("song", songName, 0, 80, 5)
    addLuaText('song');
    setTextSize('song', 25);
	...
	makeLuaText("musicians", 'Unfunny2, Penove  |', 0, 460, 5); --change this to musicians name
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 855, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 1010, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2    ]', 0, 1110, 5); --change this to artists name
	addLuaText('artists');
...
function onSongStart()
    doTweenY('hi', 'bigblackbar', 15, 1, 'circInOut');
