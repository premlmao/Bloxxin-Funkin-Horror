function onCreate()
	...
	makeLuaText("musicians", 'Coolert  |', 0, 480, 5); --change this to musicians name
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 925, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2     ]', 0, 1025, 5); --change this to artists name
	addLuaText('artists');
