function onCreate()
    ...
    makeLuaText("song", songName, 0, 170, 0)
    addLuaText('song');
    setTextSize('song', 25);
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 315, 0);
	...
	makeLuaText("musicians", 'Unfunny2 |', 0, 460, 0); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 615, 0);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 745, 0); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 905, 0);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2     ]', 0, 1005, 0); --change this to artists name
	addLuaText('artists');
...
function onSongStart()
    doTweenY('hi', 'bigblackbar', 0, 0.75, 'circInOut');
...
function onTimerCompleted(tag, loops, loopsLeft)
	...
	doTweenY('bye2', '[', -200, 0.75, 'circInOut');
	doTweenY('bye3', 'song', -200, 0.75, 'circInOut');
	doTweenY('bye4', '|', -200, 0.75, 'circInOut');
	doTweenY('bye5', 'musicText', -200, 0.75, 'circInOut');
	doTweenY('bye6', 'musicians', -200, 0.75, 'circInOut');
	doTweenY('bye7', 'chartText', -200, 0.75, 'circInOut');
	doTweenY('bye8', 'charters', -200, 0.75, 'circInOut');
	doTweenY('bye9', 'artText', -200, 0.75, 'circInOut');
    doTweenY('bye10', 'artists', -200, 0.75 , 'circInOut');
    end
end
