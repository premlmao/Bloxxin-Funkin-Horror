function onCreate()
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 355, 5);
	...
	makeLuaText("musicians", 'Unfunny2  |', 0, 500, 5); --change this to musicians name
    ...
    setTextColor("musicians", "FF0000")
    setProperty('musicians.y', -200)

    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 605, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 735, 5); --change this to charters name
	addLuaText('charters');
    ...
    setTextColor("charters", "FF0000")

    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 895, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2     ]', 0, 995, 5); --change this to artists name
	addLuaText('artists');
