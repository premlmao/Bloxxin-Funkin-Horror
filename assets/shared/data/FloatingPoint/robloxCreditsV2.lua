function onCreate()
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 335, 5);
	...
	makeLuaText("musicians", 'Grexa, Unfunny2  |', 0, 480, 5); --change this to musicians name
    ...
    setTextColor("musicians", "FFFFFF")
    setProperty('musicians.y', -200)

    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 725, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 845, 5); --change this to charters name
	addLuaText('charters');
    ...
    setTextColor("charters", "FFFFFF")

    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 1005, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2  ]', 0, 1105, 5); --change this to artists name
	addLuaText('artists');
