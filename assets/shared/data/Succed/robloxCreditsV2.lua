function onCreate()
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 285, 5);
	...
	makeLuaText("musicians", 'Grexa  |', 0, 430, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 540, 5);
	...
	makeLuaText("artists", 'Unfunny2, Brawlify  ]', 0, 925 , 5); --change this to artists name
	addLuaText('artists');
