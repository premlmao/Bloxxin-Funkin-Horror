function onCreate()
    ...
    makeLuaText("song", songName, 0, 95, 5)
    addLuaText('song');
    setTextSize('song', 25);
	...
	makeLuaText("musicians", 'Unfunny2, Grexa |', 0, 440, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 680, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 810, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 965, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2     ]', 0, 1065, 5); --change this to artists name
	addLuaText('artists');
