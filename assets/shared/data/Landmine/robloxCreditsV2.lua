function onCreate()
    ...
    makeLuaText("song", songName, 0, 125, 5)
    addLuaText('song');
    setTextSize('song', 25);
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 295, 5);
	...
	makeLuaText("musicians", 'Unfunny2 |', 0, 440, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 595, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 725, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 885, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2, Nohomatta   ]', 0, 985, 5); --change this to artists name
	addLuaText('artists');
