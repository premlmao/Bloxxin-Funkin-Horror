function onCreate()
    ...
    makeLuaText("song", songName, 0, 135, 5)
    addLuaText('song');
    setTextSize('song', 25);
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 305, 5);
	...
	makeLuaText("musicians", 'Unfunny2, Grexa |', 0, 450, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 685, 5);
	...
	makeLuaText("charters", 'Unfunny2 |', 0, 805, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 955, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2, Nil   ]', 0, 1055, 5); --change this to artists name
	addLuaText('artists');
