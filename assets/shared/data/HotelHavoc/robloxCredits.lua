...
-----------------musicians--------------------
	...
	makeLuaText("musicians", 'Coolert & Unfunny2', 0, 170, 250); --change this to musicians name
...
-----------------artists--------------------
	...
	makeLuaText("artists", 'Unfunny2 & Nil', 0, 140, 290); --change this to artists name
	addLuaText('artists');
...
-----------------quote lol--------------------
	...
	makeLuaText("quote", 'Look behind you.', 0, 20, 385); --quote editing here
	addLuaText('quote');
