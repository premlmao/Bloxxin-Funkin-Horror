function onCreate()
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 345, 5);
	...
	makeLuaText("musicians", 'Unfunny2 |', 0, 490, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 645, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 775, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 935, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2     ]', 0, 1035, 5); --change this to artists name
	addLuaText('artists');
