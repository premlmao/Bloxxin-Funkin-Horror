function onCreate()
    ...
    makeLuaText("song", songName, 0, 90, 5)
    addLuaText('song');
    setTextSize('song', 25);
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 665, 5);
	...
	makeLuaText("charters", 'Unfunny2   |', 0, 790, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 975, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2     ]', 0, 1075, 5); --change this to artists name
	addLuaText('artists');
