function onCreate()
    ...
    makeLuaText("song", songName, 0, 190, 5)
    addLuaText('song');
    setTextSize('song', 25);
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 315, 5);
	...
	makeLuaText("musicians", 'Unfunny2 |', 0, 460, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 615, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 745, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 905, 5);
	addLuaText('artText');
	...
	makeLuaText("artists", 'Unfunny2   ]', 0, 1005, 5); --change this to artists name
	addLuaText('artists');
