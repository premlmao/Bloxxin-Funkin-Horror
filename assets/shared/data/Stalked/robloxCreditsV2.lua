function onCreate()
    ...
    -----------------musicians--------------------
    makeLuaText("musicText", 'musicians:', 0, 250, 5);
	...
	makeLuaText("musicians", 'Unfunny2  |', 0, 395, 5); --change this to musicians name
    ...
    -----------------charters--------------------
    makeLuaText("chartText", 'charters:', 0, 555, 5);
	...
	makeLuaText("charters", 'Unfunny2  |', 0, 685, 5); --change this to charters name
	addLuaText('charters');
    ...
    -----------------artists--------------------
    makeLuaText("artText", 'artists:', 0, 845, 5);
	addLuaText('artText');
